...
//I used the code provided in the Assignment Introduction sheet 
//by the Professor Ferrie as a start point of this assignment
...
public class baseConv extends ConsoleProgram 
{
	...
	/**
	 * 
	 * @param digit: An integer that is between 0 to 15 that will be changed to a character
	 * @return: A way of checking if there is any errors made in the program
	 */
